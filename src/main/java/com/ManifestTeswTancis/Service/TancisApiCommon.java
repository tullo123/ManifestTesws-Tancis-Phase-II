...
public class TancisApiCommon {
    ...
    public void produceFeedbackMessage(String requestId, boolean errorYn, List<ErrorDetailDto> errorList, String outboundExchange, String callbackUrl, HttpStatus httpStatus) {
