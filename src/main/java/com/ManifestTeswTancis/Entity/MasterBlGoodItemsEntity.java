...
@Entity
@DynamicUpdate
@Table(name ="TANCISINT.CM_MF_IMPORT_MASTER_BL_GOODS")
@IdClass(MasterBlGoodItemsId.class)
public class MasterBlGoodItemsEntity implements Serializable {
    @Id
    @Column(name = "MRN")
    private String mrn;
    ...
    public MasterBlGoodItemsEntity(BillOfLadingDto bl) {
